...
DJISDKNode::initFlightControl(ros::NodeHandle& nh)
{
  ...
  flight_control_velocity_yawrate_horizbody_sub =
    nh.subscribe<sensor_msgs::Joy>(
      "dji_sdk/flight_control_setpoint_horizontalFLUvelocity_yawrate", 10,
      &DJISDKNode::flightControlVxVyVzYawrateHorizBodyCallback, this);
